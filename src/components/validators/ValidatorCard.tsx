      ...
      >
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div className="flex-1 flex flex-col gap-1 px-6 py-4">
            <span className="text-base font-heading text-black/30 dark:text-white/30 leading-none flex items-center gap-1">
              Commission:
              <Tooltip>
                <TooltipTrigger asChild>
                  <button className="text-black/30 dark:text-white/30 hover:text-black/60 dark:hover:text-white/60" aria-label="Commission info">
                    <Info className="h-3.5 w-3.5" aria-hidden="true" />
                  </button>
                </TooltipTrigger>
                <TooltipContent className="max-w-xs text-xs">
                  <p>
                    Validators earn 5% commission on rewards generated by delegated stake.{" "}
                    <a
                      href="https://docs.safefoundation.org/safenet/staking/validator-staking"
                      target="_blank"
